...
app = Flask(__name__)
app.secret_key = "35af9795288004b04c9428792157f321"  
...
def confidence_interval():
    ...
    # Scatter plot of simulated estimates, all plotted horizontally along the y-axis
    y_value = 0  # All estimates are plotted on y = 0
    plt.scatter(estimates, np.full(S, y_value), color='gray', alpha=0.8, label='Simulated Estimates')

    # Plot the confidence interval as a horizontal line
    plt.plot([ci_lower, ci_upper], [y_value, y_value], color='blue', linewidth=3, label=f'{int(confidence_level * 100)}% Confidence Interval')
